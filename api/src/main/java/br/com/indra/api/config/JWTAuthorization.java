...
public class JWTAuthorization extends BasicAuthenticationFilter{
	private final CustomUsuarioService usuarioService;
	
	public JWTAuthorization(AuthenticationManager authenticationManager, CustomUsuarioService usuarioService) {
