...
import br.com.indra.api.model.RevendaModel;
...
public class RevendaRoute {
	...
	@ApiOperation(value = "Recupera as revendas na base de dados")
	...
	@ApiOperation(value = "Recupera a revenda pelo id na base de dados")
